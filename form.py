...
class ContactForm(FlaskForm):
    ...
    subject = SelectField(
        ...
        choices=[
            ('select', _('Selecione')),
            ('consulta', _('Consultade medicina Anti Aging')),
            ('modulação_hormonal_bioidêntica', _('Modulação Hormonal Bioidêntica')),
            ('dor_cronica_inflamacao_silenciosa', _('Dor crônica e inflamação silenciosa')),
        ],
